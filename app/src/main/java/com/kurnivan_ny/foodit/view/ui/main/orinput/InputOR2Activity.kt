...
class InputOR2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.ivSearch.setOnClickListener {
            val intent = Intent(this@InputOR2Activity, EditORActivity::class.java)
        ...
        manualListAdapter.setOnItemClickListener(object : OnItemClickListener {
            override fun onItemClick(position: Int, nama_makanan: String) {
                val intent = Intent(this@InputOR2Activity, EditDetailMakananActivity::class.java)
        ...
        binding.btnKirim.setOnClickListener {
            ...
            val intent = Intent(this@InputOR2Activity, HomeActivity::class.java)
            startActivity(intent)
            finish()
        }
            ...
            if (response.isSuccessful){
                ...
                if (response_body != null){
                    if (response_body.status == "predict"){
                        ...
                        val intent = Intent(this@InputOR2Activity, InputORActivity::class.java)
