package com.kurnivan_ny.foodit.view.ui.main.fragment.home
...
import com.kurnivan_ny.foodit.view.adapter.home.ImageHomeAdapter
...
import com.kurnivan_ny.foodit.view.ui.main.manualinput.ManualInputActivity
            ...
            if (response.isSuccessful){
                ...
                if (response_body != null){
                    if (response_body.status == "predict"){
                        ...
                        val intent = Intent(activity, InputORActivity::class.java)
